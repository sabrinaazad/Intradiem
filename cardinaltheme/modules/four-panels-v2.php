<section class="section section--four-panels-v2 full-width" style="background-image: url(<?php echo the_sub_field('background_image'); ?>);" id="<?php echo the_sub_field('id'); ?>">
    <div class="section-wrapper">
        ...
        <div class="panels four-panels-v2">
